...
//            students[0] = new Student("сергей сергеййййй", [3, 4, 5]);
//            students[1] = new Student("джэк джэкккк", [3, 3, 3]);
//            students[2] = new Student("лера лераааа", [4, 3, 4]);
//            students[3] = new Student("рик рииикк", [4, 4, 5]);
//            students[4] = new Student("мартин мартинннн", [3, 2, 5]);
