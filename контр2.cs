...
class Program
{
    static void Main()
    {
        ...
        // Задание 3
        string solutionFolderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "Solution");
        Directory.CreateDirectory(solutionFolderPath);

        string task1FilePath = Path.Combine(solutionFolderPath, "task_1.json");
        string task2FilePath = Path.Combine(solutionFolderPath, "task_2.json");
