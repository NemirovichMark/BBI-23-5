...
class Program
{
   ...
   new Goods("Гранат", "P007", 109, 30)
        ...
        goods[0].ChangeDescription("описание 1 ..................");
        goods[2].ChangeDescription("описание 2 .................");
        goods[3].ChangeDescription("описание 3 ................");
...
//структуру goods переделать в абстрактный класс, и сделать 2 класса наследника: beverage и food. у напитков нужно добавить свойство концентрация сахара. цена на напиток с концентрацией сахара более 5% должна быть на 10% выше, чем начальная стоимость товара. У продуктов добавьте поле срок годности (дней). У продуктов со сроком менее месяца повысить стоимость на 5% онтосительно начальной, у продуктов со сроком более года - снизить на 5% онтосительно начальной. в основной программе сделать 2 массива из 5 элементов для каждого класса