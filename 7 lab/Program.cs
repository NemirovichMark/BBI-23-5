...
abstract class CrossRace
{
	...
	{
		Console.WriteLine($"{"Фамилия",-15}{"Группа",-10}{"Преподаватель",-20}{"Дисциплина",-10}{"Результат",-15}");
	}

	public virtual void Display()
	{
		Console.WriteLine($"{Surname,-15}{Group,-10}{TeacherLastName,-20}{"-",-10}{Result,-15}");
	}
	...
	public static void GnomeSort(List<CrossRace> runners)
	{
		int i = 0, j = 1;
...
class Sprinter100m : CrossRace
{
	...
	{
		Console.WriteLine($"{Surname,-15}{Group,-10}{TeacherLastName,-20}{"100м",-10}{Result,-15}");
	}
}
...
class Sprinter500m : CrossRace
{
	...
	public override void Display()
	{
		Console.WriteLine($"{Surname,-15}{Group,-10}{TeacherLastName,-20}{"500м",-10}{Result,-15}");
	}
}
...
class Program
{
	static void Main()
	{
		...
		// забег на 500м
		CrossRace.GnomeSort(runners500m);
		...
		// забег на 100м
		CrossRace.GnomeSort(runners100m);
