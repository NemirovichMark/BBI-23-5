...
class Program
{
    static void PrintGroupTable(List<Sportsman> group, string groupName)
    {
        ...
        Console.WriteLine($"{groupName} Участник\t\tРезультат");
        Console.WriteLine("---------------------------------");
    ...
    static void Main(string[] args)
    {
        ...
        PrintGroupTable(group1Women, "Лыжницы-1");
        PrintGroupTable(group2Women, "Лыжницы-2");
        PrintGroupTable(group1Men, "Лыжники-1");
        PrintGroupTable(group2Men, "Лыжники-2");
        PrintGroupTable(allParticipants, "Общая таблица");
